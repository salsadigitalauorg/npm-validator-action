...
def main() -> int:
    ...
    from npm_validator.report import count_blocking_findings
    ...
    blocking_findings = count_blocking_findings(report)

    # Default behavior: fail on unpatched findings unless env override set or --warn-only
    if blocking_findings and not args.warn_only:
