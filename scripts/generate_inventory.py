    ...
    if finding_rows:
        summary_block.extend(
            [
                ...
                "",
                "| Project | Package | Installed | Matched compromised versions |",
                "| --- | --- | --- | --- |",
            ]
        )
        for project, package, installed, compromised_versions in finding_rows:
            summary_block.append(
                f"| {project} | {package} | {installed} | {compromised_versions} |"
            )
        summary_block.append("")
